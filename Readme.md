# Notações FastApi Hastag
---
O projeto em questão destina-se ao [Curso de FastApi da HashTag](https://www.youtube.com/watch?v=BtIy2aD8k_w&list=PLpdAy0tYrnKy3TvpCT-x7kGqMQ5grk1Xq)  

O diretório em questão tem como objetivo realizar notações, pequenos exemplos de código, mas não conterá o projeto discutido no curso.  
Para tal será criado doravante um repositório próprio, onde nele conterá apenas o código do projeto.  
